            ...
            <div id="gallery">
                <div class="container">
                    <div class="row text-center">
                        <h2>Vídeos em construção</h2>
                        <hr>
                    </div>
                    
                    <div class="row galeria-videos"><!-- text-center col-md-12-->
                        <video width="270" height="158"  controls="controls" src="mp4/riodeDeus.mp4" poster="img/umaaduc/umaaduc-txtTema.jpg"></video>
                        <video width="270" height="158"  controls="controls" src="mp4/riodeDeus.mp4" poster="img/umaaduc/umaaduc-txtTema.jpg"></video>
                        <video width="270" height="158"  controls="controls" src="mp4/riodeDeus.mp4" poster="img/umaaduc/umaaduc-txtTema.jpg"></video>
                        <video width="270" height="158"  controls="controls" src="mp4/riodeDeus.mp4" poster="img/umaaduc/umaaduc-txtTema.jpg"></video>
                    </div>
